...
lowMat_fx   = "fy_zone_23_concat_LOW.mat";     % 低保真 fx 拼接矩阵
highMat_fx  = "fy_zone_23_concat_HIGH.mat";    % 高保真 fx 拼接矩阵（真值）
lowMat_fy   = "fx_zone_23_concat_LOW.mat";     % 低保真 fy 拼接矩阵
highMat_fy  = "fx_zone_23_concat_HIGH.mat";    % 高保真 fy 拼接矩阵
...
% —— 时轴设置 —— 
dt               = 5e-4;      % 采样步长（秒）
unstable_prefix  = 0;        % 每段开头剔除帧数（LOW/HIGH 统一）
